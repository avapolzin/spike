...
![Comparison of drizzled PSFs generated for _HST_ images using different methods included in `spike`. All panels use the same ACS/WFC imaging of the COSMOS field in F475W. \label{fig:hstcomparison}](spike_psf_hstcompare.png)
